...
class Game:
    ...
    Attributes
        ...
        player1 and player2 (Player): References to the players
        lastPlayer and nextPlayer (Player): References to player1 and player2, are exchanged between the turns
